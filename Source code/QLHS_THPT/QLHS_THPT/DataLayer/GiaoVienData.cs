...
namespace QLHS_THPT.DataLayer
{
    public class GiaoVienData
    {
        ...
        public void LuuGiaoVien(String maGiaoVien, String tenGiaoVien,   String chuyenMon)
        {
            SqlCommand cmd = new SqlCommand("INSERT INTO GIAOVIEN VALUES(@maGiaoVien, @tenGiaoVien, @chuyenMon)");
        ...
        {
            return "SELECT G.MaGiaoVien, G.TenGiaoVien, H.TenMonHoc FROM GIAOVIEN G INNER JOIN MONHOC H ON G.MaMonHoc = H.MaMonHoc";
        }

        public DataTable TimKiemGiaoVien(String hoTen, String theoCMon, String cMon)
        {
