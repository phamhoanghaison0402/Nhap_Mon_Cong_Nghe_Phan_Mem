...
namespace QLHS_THPT.Bussiness
{
    public class DiemInfo
    {
        public DiemInfo()
        {
            m_QuaTrinhHoc = new QuaTrinhHocInfo();
        ...
        private QuaTrinhHocInfo m_QuaTrinhHoc;
        public QuaTrinhHocInfo QuaTrinhHoc
        {
            get { return m_QuaTrinhHoc; }
            set { m_QuaTrinhHoc = value; }
        }
