...
namespace QLHS_THPT.Controller
{
    public class LopBUS
    {
        ...
        {
            return _lopDAL.Lay_SiSo_Lop(maLop, maNamHoc);
        }

        public int Lay_SoLop_KhoiLop(string khoiLop)
        {
            return _lopDAL.Lay_SL_KhoiLop(khoiLop);
        }

        public string Lay_KyHieu(string khoiLop)
        {
            return _lopDAL.Lay_KyHieu(khoiLop);
        }
