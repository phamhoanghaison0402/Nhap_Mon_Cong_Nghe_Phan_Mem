...
namespace QLHS_THPT.Controller
{
    public class GiaoVienCtrl
    {
        ...
        public void HienThiDataGridViewComboBoxColumn(DataGridViewComboBoxColumn cmbColumn)
        {
            ...
            cmbColumn.HeaderText = "Giáo viên chủ nhiệm";
        }

        public void HienThiDataGridViewComboBoxColumn1(DataGridViewComboBoxColumn cmbColumn)
        {
            cmbColumn.DataSource = m_GiaoVienData.LayDsGiaoVien();
            cmbColumn.DisplayMember = "TenGiaoVien";
            cmbColumn.ValueMember = "MaGiaoVien";
        ...
        {
            m_GiaoVienData.LuuGiaoVien(maGiaoVien, tenGiaoVien,  chuyenMon);
        }
        #endregion
        ...
        {
            BindingSource bS = new BindingSource();
            bS.DataSource = m_GiaoVienData.TimKiemGiaoVien(txtHoTen.Text, cmbTheoCMon.Text, cmbCMon.Text);
