...
namespace QLHS_THPT.Controller
{
    public class MonHocCtrl
    {
        ...
        public void HienThiComboBox_MonHoc(String namHoc, String lop, ComboBoxEx comboBox)
        {
            comboBox.DataSource = m_MonHocData.LayDsMonHoc(namHoc, lop);
            comboBox.DisplayMember = "TenMonHoc";
            comboBox.ValueMember = "MaMonHoc";
        }
        ...
        public void HienThiComboBox(String namHoc, String lop, ComboBoxEx comboBox)
        {
            ...
            comboBox.DataSource = m_MHData.LayDsMonHocChuaHoc(namHoc, lop);
            comboBox.DisplayMember = "TenMonHoc";
            comboBox.ValueMember = "MaMonHoc";
        }
        //Mới
        public void HienThiComboBox(String namHoc, String lop, String hocKy, ComboBoxEx comboBox)
        {
            ...
            comboBox.DataSource = m_MHData.LayDsMonHoc1(namHoc, lop, hocKy);
            comboBox.DisplayMember = "TenMonHoc";
            comboBox.ValueMember = "MaMonHoc";
        }
        #endregion
        ...
        public void HienThiDataGridViewComboBoxColumn(DataGridViewComboBoxColumn cmbColumn, String namHoc, String lop)
        {
            cmbColumn.DataSource = m_MonHocData.LayDsMonHoc(namHoc, lop);
